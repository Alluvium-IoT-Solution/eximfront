...
//   const handleWeighmentSlip = (e, container_number) => {
//     if (e.target.files.length === 0) {
//       alert("No file selected");
//     }
...
//     const params = {
//       Bucket: "exim-images",
//       Key: `weighment_slip_images/${container_number}/${e.target.files[0].name}`,
...
//     if (weighmentSlipRef.current) {
//       weighmentSlipRef.current.value = null;
//     }
//   };
...
//                         >
//                           Container Images {container.container_number}
//                         </label>
//                         <input
//                           type="file"
//                           multiple
